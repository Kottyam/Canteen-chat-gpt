...
export interface User { id:string; name:string; mobile:string; password:string; role:Role; status:Status; isFirstLogin?:boolean; canteenId?:string; canteenName?:string; needsCanteenSetup?:boolean; authProvider?:'password'|'google'; memberLoginMode?:'sr'|'mobile'; }
