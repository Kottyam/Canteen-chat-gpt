...
export interface Order { id:string; employeeId:string; memberIdentityId?:string; date:string; items:OrderItems; itemQuantities?:Record<string,number>; itemPrices?:OrderItemPrices; itemNames?:OrderItemNames; guestItems?:GuestOrderItems; guestItemQuantities?:GuestOrderQuantities; guestItemPrices?:OrderItemPrices; guestItemNames?:Record<string,string>; orderSource?:OrderSource; guestName?:string; guestCount?:number; guestTotal?:number; status?:'active'|'cancelled'; cancelledAt?:string; memberNameSnapshot?:string; memberMobileSnapshot?:string; memberDeleted?:boolean; employeeContributionPercentage?:number|null; employeeFoodAmount?:number|null; companyFoodAmount?:number|null; }
