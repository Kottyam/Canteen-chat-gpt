-- Revenue reporting-only correction.
-- The previous menu-wise query selected item_source again in sort_order
-- without aggregating/grouping it. item_source is classification metadata;
-- Guest vs normal food is already represented by the grouped financial type.
