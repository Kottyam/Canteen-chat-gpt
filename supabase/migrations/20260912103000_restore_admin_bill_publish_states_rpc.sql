-- Restore the existing Monthly Reports publish-state RPC contract.
-- This is the same authorization and calculation contract already used by
-- get_admin_bill_publish_states; it is only being restored in the deployed DB.
