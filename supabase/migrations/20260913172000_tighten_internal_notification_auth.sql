-- Tighten the internal notification authorization path.
-- Authenticated members may not invoke create_member_notification directly;
-- database triggers and scheduler calls remain supported without weakening
-- tenant isolation for normal authenticated callers.
