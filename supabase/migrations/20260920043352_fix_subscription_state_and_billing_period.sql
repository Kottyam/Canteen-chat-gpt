...
as $$
declare s public.canteen_subscriptions; p public.subscription_plans; m public.subscription_payment_methods; outp public.subscription_payments; pid uuid; expected numeric(12,2); period jsonb; v_payment_type text;
begin
