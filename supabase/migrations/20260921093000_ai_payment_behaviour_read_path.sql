...
-- This bypasses table RLS only inside a tightly scoped SECURITY DEFINER read path.
-- It never mutates payment, bill, reminder, publishing, verification, or billing state.
    ...
    'bills',
      coalesce(
        (
          ...
          where b.canteen_id = v_canteen_id
